...
This project is superceded by the new [TensorRT Inference Server](https://github.com/nvidia/tensorrt-inference-server) which will be open sourced later this year.  The async gRPC and TensorRT logic from YAIS has been incorporated into the TensorRT Inference Server.
